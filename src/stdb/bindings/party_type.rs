...
pub struct PartyCols {
    ...
    pub leader_key: __sdk::__query_builder::Col<Party, String>,
    pub created_at: __sdk::__query_builder::Col<Party, __sdk::Timestamp>,
}
...
impl __sdk::__query_builder::HasCols for Party {
    ...
    fn cols(table_name: &'static str) -> Self::Cols {
        PartyCols {
            ...
            leader_key: __sdk::__query_builder::Col::new(table_name, "leader_key"),
